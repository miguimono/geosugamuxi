...
ALTER TABLE
    public.department OWNER to postgres;
...
CREATE TABLE public.province (
    ...
    CONSTRAINT province_fk_department_fkey FOREIGN KEY (fk_department) REFERENCES public.department (id_department) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    public.province OWNER to postgres;
...
CREATE TABLE public.municipality (
    ...
    CONSTRAINT municipality_fk_province_fkey FOREIGN KEY (fk_province) REFERENCES public.province (id_province) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    public.municipality OWNER to postgres;
...
CREATE TABLE public.service_provider_tourist_plan (
    ...
    CONSTRAINT fk_actor FOREIGN KEY (id_tourist_plan) REFERENCES public.tourist_plan (id_tourist_plan) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_experience FOREIGN KEY (id_service_provider) REFERENCES public.service_provider (id_service_provider) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    public.service_provider_tourist_plan OWNER to postgres;
...
ALTER TABLE
    public.tourist_plan OWNER to postgres;
...
CREATE TABLE public.service_provider_service (
    ...
    CONSTRAINT fk_actor FOREIGN KEY (id_service) REFERENCES public.service (id_service) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_experience FOREIGN KEY (id_service_provider) REFERENCES public.service_provider (id_service_provider) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    public.service_provider_service OWNER to postgres;
...
CREATE TABLE public.service_experience (
    ...
    CONSTRAINT fk_actor FOREIGN KEY (id_service) REFERENCES public.service (id_service) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_experience FOREIGN KEY (id_experience) REFERENCES public.experience (id_experience) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    public.service_experience OWNER to postgres;
...
CREATE TABLE public.experience_heritage_site (
    ...
    CONSTRAINT fk_actor FOREIGN KEY (id_heritage_site) REFERENCES public.heritage_site (id_heritage_site) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION,
    CONSTRAINT fk_experience FOREIGN KEY (id_experience) REFERENCES public.experience (id_experience) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    public.experience_heritage_site OWNER to postgres;
...
ALTER TABLE
    public.heritage_site OWNER to postgres;
...
ALTER TABLE
    public.experience OWNER to postgres;
...
ALTER TABLE
    public.service OWNER to postgres;
...
CREATE TABLE public.service_provider (
    ...
    CONSTRAINT service_provider_fk_municipality_fkey FOREIGN KEY (fk_municipality) REFERENCES public.municipality (id_municipality) MATCH SIMPLE ON UPDATE NO ACTION ON DELETE NO ACTION
) TABLESPACE pg_default;

ALTER TABLE
    public.service_provider OWNER to postgres;